...
model.set_transition('marriage.S', 'marriage.I', ['business.UV'], 0.9)
model.set_transition('marriage.S', 'marriage.I', ['business.V'], 0.3)

model.set_transition('business.UV', 'business.V', ['marriage.S'], 0.05)
model.set_transition('business.UV', 'business.V', ['marriage.I'], 0.03)
