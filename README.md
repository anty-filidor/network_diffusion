# Network Diffusion - spread processes in multilayer networks
...
This repository contains a package to design and run phenomena-diffusion
experiments in multilayer networks. Package has been built basing on
